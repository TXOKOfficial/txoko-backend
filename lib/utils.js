...
// ── Resend ────────────────────────────────────────────
// El remitente (FROM_EMAIL) es una direccion del dominio verificado y NO
// necesita existir como casilla: Resend firma y envia igual. Pero si alguien
// le responde a ese mail, rebota. Por eso todo envio lleva un Reply-To hacia
// una casilla real. Por defecto la del owner; REPLY_TO permite otra.
